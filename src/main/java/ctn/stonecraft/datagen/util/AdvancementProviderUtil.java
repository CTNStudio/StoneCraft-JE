package ctn.stonecraft.datagen.util;
 ...
 * 进度数据生成工具
 */
public class AdvancementProviderUtil {
	...
	public static AdvancementHolder save(Advancement.Builder builder, Consumer<AdvancementHolder> output, String id) {
		AdvancementHolder advancementholder = builder.build(modRL(id));
	...
	public static @NotNull MutableComponent translatable(String key) {
		return Component.translatable("advancements.%s.%s".formatted(ID, key));
	}
